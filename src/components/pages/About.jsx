...
const About = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="font-sans overflow-x-hidden text-[rgba(0,0,0,0.75)]"
    >
      {/* ---------- WHO WE ARE ---------- */}
      ...
      {/* ---------- MEET OUR FOUNDER ---------- */}
      <section className=" px-6 md:px-16 py-20 flex flex-col md:flex-row items-center gap-20">
        {/* LEFT IMAGE */}
        <motion.div
        ...
        >
          ...
          <p>
            Hi, I am Heena Gupta, Founder & CEO of Rhombus Education & Immigration
            Services.
          </p>
          <p>
            With over 15 years of experience in the education and immigration
            field, we have guided hundreds of students worldwide.
          </p>
          <p>
            Our mission is to empower students with personalized education and
            immigration solutions, ensuring transparency, trust, and success.
          </p>
          <p>
            We combine expertise, certifications from the British Council & ICEF,
            and a dedicated team to make your study abroad journey seamless and
            successful.
          </p>
          <p>
            Let us help you take the next step in your academic and professional
      ...
      <section className=" px-6 md:px-16 py-20 flex flex-col md:flex-row items-center gap-20">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h2 className="font-forum text-[36px] text-black mb-4">Meet Our CoFounder</h2>
          <p>
            Hi, I am Debraj Banerjee, CoFounder & CEO of Rhombus Education & Immigration
            Services.
          </p>
          <p>
            With over 15 years of experience in the education and immigration
        ...
        >
          ...
          <div className="md:w-[50%] w-full">
            <p className="font-dm-sans text-[16px] leading-[24px] text-[rgba(0,0,0,0.75)]">
              ...
              making studying abroad an achievable and exciting opportunity. With a
              focus on personalized care and expert consultancy, we ensure every
              student has a smooth, efficient, and successful journey—from choosing
              the right university to obtaining a student visa.
            </p>
          </div>
        </motion.div>
      </section>
      ...
      <section className="bg-white px-10 md:px-16 py-20">
        ...
        >
          ...
          specialists, and support staff, all dedicated to providing exceptional
          service.
        </motion.p>
          ...
          {teamMembers.map((member, idx) => (
            ...
            >
              ...
              <div className="text-left mt-4 w-full">
                <h4 className="font-forum text-[20px] text-black">
                  {member.name}
                </h4>
