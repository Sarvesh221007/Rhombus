...
const ceos = [
  {
    logo: "/about/founder.jpeg",
    name: "Heena Gupta",
    position: "Founder & CEO",
    company: "Rhombus Education and Immigration Services",
    paragraph:
      "With over 15 years of experience in international education and student visa consultancy, I founded Rhombus to make global education accessible and stress-free. Our goal is to empower students with transparent guidance and personalized support at every step of their journey.",
    stat: "Student Success Rate",
    statValue: "95%",
    statText: "Visa & admission approvals worldwide",
  },
  {
    logo: "/about/co_founder.jpg",
    name: "Debraj Banerjee",
    position: "Co-Founder & Director",
    company: "Rhombus Education and Immigration Services",
    paragraph:
      "At Rhombus, we focus on building trusted relationships with students and education agents globally. Our expertise and certifications from ICEF and the British Council ensure accuracy, integrity, and exceptional outcomes in every application we handle.",
    stat: "Partner Network",
    statValue: "1500+",
    statText: "Global universities & education partners",
  },
  {
    logo: "/about/s_manager.jpg",
    name: "Monalisa Guha",
    position: "Senior Admission Manager",
    company: "Rhombus Education and Immigration Services",
    paragraph:
      "Every student’s dream deserves a clear path. From course selection to document review, my focus is on precision and personalized support, ensuring each application reflects the student’s true potential and passion.",
    stat: "Applications Processed",
    statValue: "10K+",
    statText: "Successful admissions guided each year",
  },
];
